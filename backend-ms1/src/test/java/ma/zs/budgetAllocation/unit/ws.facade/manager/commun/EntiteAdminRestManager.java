package ma.zs.budgetAllocation.unit.ws.facade.manager.commun;

import ma.zs.budgetAllocation.bean.core.commun.EntiteAdmin;
import ma.zs.budgetAllocation.service.impl.manager.commun.EntiteAdminAdminServiceImpl;
...
import ma.zs.budgetAllocation.ws.facade.manager.commun.EntiteAdminRestAdmin;
...
public class EntiteAdminRestManager {

    private MockMvc mockMvc;

    @Mock
    private EntiteAdminManagerServiceImpl service;
    @Mock
    private EntiteAdminConverter converter;

    @InjectMocks
    private EntiteAdminRestManager controller;

...
import ma.zs.budgetAllocation.service.impl.manager.commun.EmployeAdminServiceImpl;
import ma.zs.budgetAllocation.ws.converter.commun.EmployeConverter;
import ma.zs.budgetAllocation.ws.dto.commun.EmployeDto;
import ma.zs.budgetAllocation.ws.facade.manager.commun.EmployeRestAdmin;
...
public class EmployeRestManager {

    private MockMvc mockMvc;

    @Mock
    private EmployeManagerServiceImpl service;
    @Mock
    private EmployeConverter converter;

    @InjectMocks
    private EmployeRestManager controller;

...
public class EmployeRestManager  extends AbstractController<Employe, EmployeDto, EmployeCriteria, EmployeManagerService, EmployeConverter> {
    ...
    public EmployeRestManager (EmployeManagerService service, EmployeConverter converter) {

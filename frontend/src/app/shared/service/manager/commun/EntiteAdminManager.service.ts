...
export class EntiteAdminManagerService extends AbstractService<EntiteAdminDto, EntiteAdminCriteria> {
    ...
    get API() {
        return environment.apiUrlBudgetAllocationservice + 'manager/entiteAdmin/';
    }
}

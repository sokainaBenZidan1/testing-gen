...
@Component({
  selector: 'app-entite-admin-edit-manager',
  templateUrl: './entite-admin-edit-manager.component.html'
})
export class EntiteAdminEditManagerComponent extends AbstractEditController<EntiteAdminDto, EntiteAdminCriteria, EntiteAdminManagerService>   implements OnInit {

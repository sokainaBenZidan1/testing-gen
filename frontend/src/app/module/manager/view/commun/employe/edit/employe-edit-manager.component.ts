...
@Component({
  selector: 'app-employe-edit-manager',
  templateUrl: './employe-edit-manager.component.html'
})
export class EmployeEditManagerComponent extends AbstractEditController<EmployeDto, EmployeCriteria, EmployeManagerService>   implements OnInit {

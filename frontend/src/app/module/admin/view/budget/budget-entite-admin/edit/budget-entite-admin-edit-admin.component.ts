...
@Component({
  selector: 'app-budget-entite-admin-edit-admin',
  templateUrl: './budget-entite-admin-edit-admin.component.html'
})
export class BudgetEntiteAdminEditAdminComponent extends AbstractEditController<BudgetEntiteAdminDto, BudgetEntiteAdminCriteria, BudgetEntiteAdminAdminService>   implements OnInit {
